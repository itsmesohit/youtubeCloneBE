...
const generateAccessTokenAndRefreshToken = async (userId) => {
    try{
        ...
        throw new Error(500, "Error while generating access token and refresh token");
...
const registerUser = asyncHandler(async ( req, res ) => {
     // get user details, validate and save to database
...
const changeCurrentPassword = asyncHandler(async ( req, res ) => {
    ...
    user.password = newPassword; // First encrypt the password and then save it
